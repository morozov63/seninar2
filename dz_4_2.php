...
$skills = [
 ...
 $experience = [
      ...
      'text' => ['Приятно хорошо провести время', 'Временное решение проблемы', 'повышенные скидки']
      ]
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php for ($i = 0; $i< count ($experience['who']); $i++) { ?>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $experience['who'][$i]?>  </b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience['when'][$i]?></h6>
          <p><?php echo $experience['text'][$i]?></p>
          <hr>
        </div>
        <?php } ?>
