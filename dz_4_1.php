...
$skills = [
    ...
    $text_0 = 'Приятно хорошо провести время';
    $text_1 ='Временное решение проблемы';
    $text_2 = 'повышенные скидки';
    
$experience = [
      'who' => ['Разработчик переднего плана', 'Web разработчик', 'Графический дизайнер'], 
      'when' => ['Jan 2015 - настоящее время', 'Mar 2012 - Dec 2014', 'Jun 2010 - Mar 2012'], 
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $experience ['who'][0] ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience ['when'][0] ?></h6>
          <p><?php echo $experience ['text'][0] ?></p>
          <hr>
        </div>
        
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $experience ['who'][1] ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience ['when'][1] ?></h6>
          <p><?php echo $experience ['text'][1] ?></p>
          <hr>
        </div>
        
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $experience ['who'][2] ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience ['when'][2] ?></h6>
          <p><?php echo $experience ['text'][2] ?> </p><br>
        </div>
      </div>
